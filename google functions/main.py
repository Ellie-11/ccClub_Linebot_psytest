    ...
    try:
       ...
       if msg == '開始測驗':                    # 開始測驗樣板
        ...
        line_bot_api.reply_message(tk,TemplateSendMessage(
          ...
          reply_bye_array = []                         # 建立一個回覆使用者拒絕的訊息陣列
  ...
  "contents": [
    {
      ...
      "body": {
        ...
        "position": "relative"
          ...
          line_bot_api.reply_message(tk, reply_bye_array)  # 回覆使用者拒絕的訊息陣列

       elif msg == 'Got it! 開始吧！':           # 處理開始測驗
          fdb.delete('/', None)                 # 每次開始前，都將所有資料清空
          ...
          if start:   
            ...
            reply_array.append( ImageSendMessage(original_content_url = result[2], preview_image_url = result[2])) 
            # 回覆測驗結果訊息(image)
